...
html_temp = """
    ...
    <center><h3> [Apple golden, Apple Red, Banana, Guava, Kiwi, Orange, Mango, Mango Red, Pineapple, Watermelon] </h3></center>
    </div>
    """
...
if image is not None:
    ...
    try:
        ...
        if st.button("Classify"):
            ...
            model_dir = "Model/model2a.h5"
            model = keras.models.load_model(model_dir)

            # Labels
            train_labels = {
                'apple': 0, 'avocado': 1, 'banana': 2, 'kiwi': 3, 'orange': 4, 'pineapple': 5, 'strawberry': 6
                  }
            ...
            # Displaying output
            st.info(
                f'The uploaded image has been classified as " {result}"  with Accuracy {acc}%.'
            )
